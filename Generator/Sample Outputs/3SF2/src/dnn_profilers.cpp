...
{{
	...
	act_json << Conv_Relu_6.get_json_string("Conv_Relu_6") << "," << std::endl;
	act_json << Conv_Relu_7.get_json_string("Conv_Relu_7") << "," << std::endl;
	act_json << ConvTranspose_Relu_8.get_json_string("ConvTranspose_Relu_8") << "," << std::endl;
	act_json << Concat_0.get_json_string("Concat_0") << "," << std::endl;
	act_json << Conv_Bn_Relu_9.get_json_string("Conv_Bn_Relu_9") << "," << std::endl;
	act_json << Conv_Bn_Relu_10.get_json_string("Conv_Bn_Relu_10") << "," << std::endl;
	act_json << ConvTranspose_Relu_11.get_json_string("ConvTranspose_Relu_11") << "," << std::endl;
	act_json << Concat_1.get_json_string("Concat_1") << "," << std::endl;
	act_json << Conv_Bn_Relu_12.get_json_string("Conv_Bn_Relu_12") << "," << std::endl;
	act_json << Conv_Bn_Relu_13.get_json_string("Conv_Bn_Relu_13") << "," << std::endl;
	act_json << ConvTranspose_Relu_14.get_json_string("ConvTranspose_Relu_14") << "," << std::endl;
	act_json << Concat_2.get_json_string("Concat_2") << "," << std::endl;
	act_json << Conv_Bn_Relu_15.get_json_string("Conv_Bn_Relu_15") << "," << std::endl;
	act_json << Conv_Bn_Relu_16.get_json_string("Conv_Bn_Relu_16") << "," << std::endl;
	act_json << Conv_14.get_json_string("Conv_14") << std::endl;
	act_json << "]" << std::endl;
	act_json.close();
}}
